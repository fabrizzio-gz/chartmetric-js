...
describe("flatten tracks", () => {
    const data = (0, script_1.fetchData)();
    const flattenData = [
    ...
    test.each([
        ...
        const result = (0, script_1.flattenTracks)(input);
        expect(result).toEqual(expected);
    });
});
describe("sort tracks", () => {
    const tracks = (0, script_1.flattenTracks)((0, script_1.fetchData)());
    const sortedTracks = [
        { timestp: "2021-04-07", trackName: "Captain Hook" },
        { timestp: "2021-04-08", trackName: "Peaches" },
        { timestp: "2021-04-08", trackName: "Savage" },
    ...
    test.each([
        ...
        const result = (0, script_1.sortTracks)(input);
        expect(result).toEqual(expected);
    });
});
describe("group tracks by date", () => {
    const data = (0, script_1.sortTracks)((0, script_1.flattenTracks)((0, script_1.fetchData)()));
    const tracksByDate = [
    ...
    test.each([
        ...
        const result = (0, script_1.groupTracksByDate)(input);
        expect(result).toEqual(expected);
    });
});
describe("get tooltip", () => {
    ...
    const thirdTooltip = "Savage (1), Savage (feat. Beyonce) (1), Captain Hook (1)";
    test.each([
        ...
        const result = (0, script_1.getTooltip)(input);
        expect(result).toEqual(expected);
    });
});
describe("get total play count", () => {
    ...
    test.each([
        ...
        const result = (0, script_1.getTotalPlayCount)(input);
        expect(result).toEqual(expected);
    });
});
describe("Process API data", () => {
    test("resturns expected result", () => {
        const input = (0, script_1.fetchData)();
        const expected = [
            {
                x: "2021-04-07",
                y: 1,
        ...
        const result = (0, script_1.processApiData)(input);
        expect(result).toEqual(expected);
    });
});
